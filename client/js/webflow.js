...
Webflow.require('ix').init([
  {"slug":"rubros","name":"rubros","value":{"style":{},"triggers":[{"type":"click","selector":".contrubros","stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"publis","name":"publis","value":{"style":{},"triggers":[{"type":"hover","stepsA":[{"transition":"transform 200ms ease-in 0ms","scale":1.06}],"stepsB":[{"transition":"transform 200ms ease-in 0ms","scale":1}]}]}},
  {"slug":"titulo","name":"titulo","value":{"style":{},"triggers":[{"type":"scroll","offsetBot":"300px","stepsA":[{"transition":"transform 500ms ease-in 0ms","x":"0px","y":"67px"}],"stepsB":[]}]}},
  {"slug":"offmasinfo","name":"offMasInfo","value":{"style":{},"triggers":[{"type":"click","stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"telefonos","name":"telefonos","value":{"style":{},"triggers":[{"type":"click","selector":".conttelefonos","stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"contenedor-rubros","name":"contenedor rubros","value":{"style":{},"triggers":[{"type":"hover","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]}]}},
  {"slug":"contenedor-telefonos","name":"contenedor telefonos","value":{"style":{},"triggers":[{"type":"hover","stepsA":[],"stepsB":[{"display":"none"}]}]}}
]);
